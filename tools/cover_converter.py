...
try:
    from .cover_converter_v2 import (
        DITHER_MODES,
        RESAMPLE,
        add_image_options,
        iter_images,
...
except ImportError:  # Direct execution: python tools/cover_converter.py
    from cover_converter_v2 import (  # type: ignore
        DITHER_MODES,
        RESAMPLE,
        add_image_options,
        iter_images,
    )
    from sfcov import (  # type: ignore
        Cover,
        CoverFormatError,
        HEIGHT,
        MAX_PALETTE_COLORS,

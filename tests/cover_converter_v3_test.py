...
from tools.cover_converter import image_to_cover as image_to_v2_cover
from tools.cover_converter_v3 import (
    batch_convert,
    convert_file,
    cover_to_image,
    image_to_cover,
)
from tools.sfcov import Cover as CoverV2, CoverFormatError as CoverV2Error
from tools.sfcov_v3 import (
    Cover,
    CoverFormatError,
    HEADER_SIZE,
    HEIGHT,
...
class CoverConverterV3Test(unittest.TestCase):
